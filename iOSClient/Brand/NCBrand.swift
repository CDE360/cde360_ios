...
class NCBrandColor: NSObject {
    ...
    // Color
    @objc public let customer:              UIColor = UIColor(red: 31/255.0, green: 33.0/255.0, blue: 36.0/255.0, alpha: 1.0)    // BLU NC : #0082c9
    ...
    @objc public func setDarkMode() {
        ...
        if darkMode {
            tabBar = UIColor(red: 31.0/255.0, green: 33.0/255.0, blue: 36.0/255.0, alpha: 1.0)
